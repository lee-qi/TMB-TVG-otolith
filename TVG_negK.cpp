...
#define TMB_LIB_INIT R_init_TVG_negK
#include <TMB.hpp>
template<class Type>
Type objective_function<Type>::operator() ()
{
  ...
  PARAMETER_VECTOR(logbetaK);                 // Only first parameter is constrained
...
//  PARAMETER(Rho);
  ...
  vector<Type> betaK(Nsex);
//  vector<Type> betaW(Nsex);
